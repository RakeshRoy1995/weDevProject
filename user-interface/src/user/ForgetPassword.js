            ...
            if (password == RetypePassword && password ) {
                axios.post('userCreate', {
                    ...
                    .then(function (response) {
                        ...
                        cogoToast.success("Please Login now" , {position: 'top-right' });
        ...
        <div className="container">
            ...
            <div className="col-lg-4 col-10 col-sm col-md-9 m-auto">
                ...
                <div className="login-text">
                    <p style={{ color: "red" }}>
                         {errorMsg == true ? "Email, Name , Password Fields are mendatory" : <> {errorMsgPassword? "Password is required & Check the password confirmation" : ""} </>} </p>
                    <Form>
