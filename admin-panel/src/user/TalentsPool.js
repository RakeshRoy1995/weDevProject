...
function TalentsPool() { 
    ...
    const [clickOnRemove, setClickOnRemove] = useState(false);
    ...
    const reviewYourTeam = (e) =>{ 
        ...
        if(TeamMemberID == null){
            ...
            alert("Please select your team name")
        }
        else{
        ...
        for( var i = 0; i < TeamMember.length; i++){ 
            if (  TeamMember[i].props.className.includes(id) ) { 
                ...
                if(TeamMember.length <=4){
                    allslicker =  document.getElementsByClassName("allSlickSlider")
                }
                setTeamMember(TeamMember)
            }
        }

        if(allslicker != undefined){
            for (let index = 0; index < allslicker.length; index++) {
                allslicker[index].style.display = "block";
    ...
    const AddTeam = (e , id) => {
        ...
        if(TeamMemberKey.includes(id)){
            ...
            routerHistory.push("db_v2_member");
                ...
                <div className="col-lg-12">
                    ...
                    <div className="row">
...

                        {
                            ...
                            <div className= {key <10 || key ==0 ? "col-lg-6 " : "col-lg-6 pl-0  display_none" } key={key} id={"employee_" + key} data-name={post.emp_name} >
