...
function ReviewTeamMember() {
    ...
    const reviewYourTeam = (e) =>{ 
        ...
        if(TeamMemberID == null || TeamMemberID == ""){
            document.getElementById("errorTeamMember").style.border = "2px solid red"
            document.getElementById("errorTeamMember").innerHTML = "Please select team member"
            document.getElementById("errorTeamMember").style.color = "red"
        }else if(teamName == "" || teamName == null ){
            document.getElementById("takeTeamName").style.color = "red"
        }
        else{
    ...
    const Calculator = ()=>{
        let total = 0;
        for (let index = 0; index < data.length; index++) {
            if( localStorage.getItem("TeamMemberID").includes(data[index].id) ){
    ...
    const RemoveTeamMemberAlreadyExist =(e, id , key) =>{
        ...
        // debugger
        let MemberID =  localStorage.getItem('TeamMemberID' );
        let array = [];
        ...
        localStorage.setItem('TeamMemberID' , array )
    ...
    const AddTeam = (e , id , member_id) => {
        ...
        if(TeamMemberKey.includes(id)){
            ...
            let teammembers = localStorage.getItem("TeamMemberID")
            let array = []
    ...
    function fetchData_2(filter="" , status="" , dropdownSort=""){
        ...
        .then(res => {
            ...
            if(localStorage.getItem("TeamMemberID") != null && localStorage.getItem("TeamMemberID") != ""){
                
                for (let index = 0; index < res.data.length; index++) {
                    if( localStorage.getItem("TeamMemberID").includes( res.data[index].id ) ){

                        total += res.data[index].salary;
                        localStorage.setItem('TeamMemberID', localStorage.getItem("TeamMemberID") );
                        TeamMember.push( 
    ...
    function fetchData(filter="" , status="" , dropdownSort=""){
        ...
        .then(res => {
            ...
            if(res.data.length >= 10 ){
                ...
                setshowingLast(res.data.length)
            }
    ...
    const cacheIssue = () =>{
        let allmember =  localStorage.getItem('TeamMemberID' );
        let getSlickerItem = document.getElementsByClassName("allSlickSlider")

        if(getSlickerItem.length > 0){
            let getShowItem = document.getElementsByClassName("add-team ")
            let totalMember = localStorage.getItem("TeamMemberID")
            for (let index = 0; index < data.length; index++) {
                if( totalMember.includes( data[index].id ) ){
                    if( document.getElementsByClassName("emp_id_" + data[index].id )[0] != undefined ){
                        document.getElementsByClassName("emp_id_" + data[index].id )[0].style.display = "none";
                    }
                }else{
                    if( document.getElementsByClassName("emp_id_" + data[index].id )[0] != undefined ){
                        document.getElementsByClassName("emp_id_" + data[index].id )[0].style.display = "block";
                    }
                }
            }
        ...
        <div className="right_content">
            ...
            <div className="your-team-name">
                ...
                <div className="name-text">
                    <h1>
                    <spna id="takeTeamName"> { localStorage.getItem("teamName") != null && localStorage.getItem("teamName") != "" ? localStorage.getItem("teamName") : "Your Team Name" }  </spna>
                    {/* <svg
                        width={24}
                        height={24}
                        viewBox="0 0 24 24"
                    ...
                    if (TeamMember.length == 0 ) {
                        return(
                            <div className="no_member_box-item">
                                <p id="errorTeamMember" >No Member added</p>
                            </div> 
                        )
                    } else {
                        return(
                                    ...
                                    <div className="resume-part-flex">
                                        ...
                                        {(() => {
                                            if ( post.emp_status == 1 ) {
                                                return(
                                                    ...
                                                    <div className={ localStorage.getItem("TeamMemberID").includes(post.id) == true ? "display_none" : "add-team" }   onClick={(e)=> AddTeam( e ,key , post.id  ) } id={"add-team-"+ key } >
                                        ...
                                        {(() => {
                                            if ( localStorage.getItem("TeamMemberID") ) {
                                                if( localStorage.getItem("TeamMemberID").includes(post.id)){
